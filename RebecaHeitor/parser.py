    ...
    def jsonOut(self, data,db,dict_manu):
        ...
        for key in (clients):
            ...
            if mac == "18:FE:34:D6:EA:8E":   
                ...
                message = 'Mac ' + mac + 'AP1 ' + 'Power ' + power + 'Fabricante ' + manufacturer
                try:
                    s.sendall(message)
                except socket.error:
                    print 'Send Fail'
...
if __name__ == "__main__":
    ...
    while(True):
        airoCommandLine = "airodump-ng wlo1mon --write tt.csv --output-format csv"
        ...
        p.parser("tt.csv-01.csv",riotdb,dict_manu)
